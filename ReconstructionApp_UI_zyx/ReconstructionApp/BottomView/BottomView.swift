        ...
        VStack {
            HStack {
                ...
                case .ready, .error:
                    EmptyView()
                case .calibrating:
                    CalibrationProgressView(dataModel: appDataModel)
                ...
                case .calibration_viewing:
                    Button("Start Quick Reconstructing") {
                        ...
                        Task {
                            await appDataModel.startQuickReconstruction()
                        }
                    }
                ...
                case .quick_reconstruction_viewing:
                    Button("Start GS Reconstructing") {
                        ...
                        Task {
                            await appDataModel.startGSReconstruction()
                        }
                    }
